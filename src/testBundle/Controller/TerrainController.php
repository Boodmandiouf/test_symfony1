...
use testBundle\Entity\Terrain;
use testBundle\Form\TerrainType;
...
class TerrainController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $terrains = $em->getRepository('testBundle:Terrain')->findAll();
    ...
    {
        $terrain = new Terrain();
        $form = $this->createForm('testBundle\Form\TerrainType', $terrain);
    ...
    {
        $deleteForm = $this->createDeleteForm($terrain);
        $editForm = $this->createForm('testBundle\Form\TerrainType', $terrain);
