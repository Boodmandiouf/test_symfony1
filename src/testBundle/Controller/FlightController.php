...
use testBundle\Entity\Flight;
use testBundle\Form\FlightType;
...
class FlightController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $flights = $em->getRepository('testBundle:Flight')->findAll();
    ...
    {
        $flight = new Flight();
        $form = $this->createForm('testBundle\Form\FlightType', $flight);
    ...
    {
        $deleteForm = $this->createDeleteForm($flight);
        $editForm = $this->createForm('testBundle\Form\FlightType', $flight);
